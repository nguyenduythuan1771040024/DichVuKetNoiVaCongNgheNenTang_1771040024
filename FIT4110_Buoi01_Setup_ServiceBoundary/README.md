...
```
    ...
    git remote add origin https://github.com/nguyenduythuan1771040024/DichVuKetNoiVaCongNgheNenTang_1771040024.git
    git push -u origin main
    ```

    Repository nên để **Public** và đặt tên `DichVuKetNoiVaCongNgheNenTang_1771040029`.
